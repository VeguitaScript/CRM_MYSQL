...
class OpComercial(BaseModel):
    names = models.CharField(max_length=150, verbose_name='Nombres')
    surnames = models.CharField(max_length=150, verbose_name='Apellidos')
    op_comercial = models.CharField(max_length=30, choices=op_comercial_choices, default='En Proceso', verbose_name='Oportunidad Comercial')
    ...
    def toJSON(self):
        item = model_to_dict(self)
        item['op_comercial'] = {'id':self.op_comercial,'name':self.get_op_comercial_display()} 
        return item
